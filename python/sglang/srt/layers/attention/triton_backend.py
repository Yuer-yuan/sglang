...
class TritonAttnBackend(AttentionBackend):
    def __init__(
        ...
        # A PP worker only owns its local layer interval.  Layer 0 is not a
        # valid global layer id on later stages.
        local_layer_id = getattr(model_runner.token_to_kv_pool, "start_layer", 0)
